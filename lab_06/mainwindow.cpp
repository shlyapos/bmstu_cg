...
// Drawing - true, fill - false
bool click_mode(true);
...
void MainWindow::initButton()
{
    ...
    connect(ui->btn_draw_figure, SIGNAL(released()), this, SLOT(figureDrawButton()));
...
{
    ui->lbl_mode_click->setText("Заполнение");
    click_mode = false;

    ui->btn_fill_figure->setFlat(true);
    ui->btn_draw_figure->setFlat(false);
}

void MainWindow::figureDrawButton()
{
    ui->lbl_mode_click->setText("Рисование");
    click_mode = true;

    ui->btn_fill_figure->setFlat(false);
    ui->btn_draw_figure->setFlat(true);
}
